...
export default function Modal() {
  ...
  return (
    <div className='flex  flex-col items-center justify-center gap-1 p-4  w-1/1'>
        ...
        <div className ={`flex justify-cemter bg-slate-800 w-[310px] p-3 rounded-xl ${openModal}`}>
             <AutoComplete/>
             <Button className='border border-slate-900 p-3 rounded  bg-pink-700 hover:bg-pink-800  max-h-6 flex items-center m-3 mr-' type='submit' onClick={canc} name={'X'}/>
        </div>
    </div>
  )
}
